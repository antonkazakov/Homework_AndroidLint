...
import ru.otus.homework.lintchecks.ColorUsageDetector

@Suppress("UnstableApiUsage")
internal class ColorUsageDetectorTest {
    private val lintTask = lint()
        .allowMissingSdk()
        .issues(ColorUsageDetector.ISSUE)

    @Test
    fun `detect invalid color in layout`() {
        lintTask.files(
            xml(
    ...
    @Test
    fun `detect invalid color in drawable`() {
        lintTask.files(
            xml(
    ...
    @Test
    fun `detect invalid color in selector`() {
        lintTask
            .files(
                xml(

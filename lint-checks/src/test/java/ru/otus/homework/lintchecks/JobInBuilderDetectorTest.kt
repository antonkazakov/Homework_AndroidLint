...
internal class JobInBuilderDetectorTest {
    ...
    private val lintTask = lint().allowMissingSdk().issues(JobInBuilderUsageDetector.ISSUE)

    //TODO ни как не могу понять почему этот тест ругается на
    // java.lang.IllegalStateException:
    // app/src/ru/otus/homework/linthomework/jobinbuilderusage/JobInBuilderTestCase.kt:2: Error:

...
class RawColorUsageDetectorTest {
    ...
    private val lintTask = lint().allowMissingSdk().issues(RawColorUsageDetector.ISSUE)
    ...
    private val expected = """
        res/drawable/ic_baseline_adb_24.xml:4: Warning: Используемые цвета должны браться из палитры. [RawColorUsage]
            android:tint="#b4ffff"
                          ~~~~~~~
        res/layout/incorrect_color_usages_layout.xml:11: Warning: Используемые цвета должны браться из палитры. [RawColorUsage]
                android:background="#FF3700B3"
                                    ~~~~~~~~~
        res/layout/incorrect_color_usages_layout.xml:20: Warning: Используемые цвета должны браться из палитры. [RawColorUsage]
                android:background="#00bcd4"
                                    ~~~~~~~
        res/color/selector.xml:3: Warning: Используемые цвета должны браться из палитры. [RawColorUsage]
            <item android:color="#5C6BC0" android:state_enabled="true" />
                                 ~~~~~~~
        res/color/selector.xml:4: Warning: Используемые цвета должны браться из палитры. [RawColorUsage]
            <item android:color="#C5CAE9" />
                                 ~~~~~~~
        0 errors, 5 warnings
    """.trimIndent()

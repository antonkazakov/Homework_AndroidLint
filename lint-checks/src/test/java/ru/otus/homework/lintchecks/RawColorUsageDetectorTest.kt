...
class RawColorUsageDetectorTest {
    ...
    private val lintTask = TestLintTask.lint().allowMissingSdk().issues(RawColorUsageDetector.ISSUE)
    ...
    private val incorrectColorUsagesLayoutFile = xml("res/layout/incorrect_color_usages_layout.xml",
        """
                <?xml version="1.0" encoding="utf-8"?>
    ...
    private val selectorFile = xml("res/color/selector.xml",
        """
            <?xml version="1.0" encoding="utf-8"?>
    ...
    private val expected = """
        res/drawable/ic_baseline_adb_24.xml:4: Warning: Raw color use is not recommended. [RawColorUsage]
            android:tint="#b4ffff"
                          ~~~~~~~
        res/layout/incorrect_color_usages_layout.xml:12: Warning: Raw color use is not recommended. [RawColorUsage]
                android:background="#FF3700B3"
                                    ~~~~~~~~~
        res/layout/incorrect_color_usages_layout.xml:22: Warning: Raw color use is not recommended. [RawColorUsage]
                android:background="#00bcd4"
                                    ~~~~~~~
        res/color/selector.xml:3: Warning: Raw color use is not recommended. [RawColorUsage]
            <item android:color="#5C6BC0" android:state_enabled="true" />
                                 ~~~~~~~
        res/color/selector.xml:4: Warning: Raw color use is not recommended. [RawColorUsage]
            <item android:color="#C5CAE9" />
                                 ~~~~~~~
        0 errors, 5 warnings
            """.trimIndent()

...
class ColorPaletteDetectorTest {
    ...
    @Test
    fun `check incorrect_color_usages_layout`() {
        ...
        val expected =
            """
                res/layout/incorrect_color_usages_layout.xml:12: Error: Использование цветов не из палитры недопустимо [ColorsUsage]
                        android:background="#FF3700B3"
                                            ~~~~~~~~~
                res/layout/incorrect_color_usages_layout.xml:22: Error: Использование цветов не из палитры недопустимо [ColorsUsage]
                        android:background="#00bcd4"
                                            ~~~~~~~
                2 errors, 0 warnings
            """.trimIndent()
    ...
    fun `check selector`() {
        ...
        val expected =
            """
                res/color/selector.xml:3: Error: Использование цветов не из палитры недопустимо [ColorsUsage]
                    <item android:color="#5C6BC0" android:state_enabled="true" />
                                         ~~~~~~~
                res/color/selector.xml:4: Error: Использование цветов не из палитры недопустимо [ColorsUsage]
                    <item android:color="#C5CAE9" />
                                         ~~~~~~~
                2 errors, 0 warnings
            """.trimIndent()
    ...
    fun `check ic_baseline_adb_24`() {
        ...
        val expected =
            """
                res/drawable/ic_baseline_adb_24.xml:4: Error: Использование цветов не из палитры недопустимо [ColorsUsage]
                android:tint="#b4ffff"
                              ~~~~~~~
                1 errors, 0 warnings
            """.trimIndent()

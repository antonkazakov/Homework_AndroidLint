...
import ru.otus.homework.lintchecks.RawColorUsageDetector

@Suppress("UnstableApiUsage")
class RawColorUsageDetectorTest {
    private val colorXml: TestFile = TestFiles.xml(
    ...
    fun detektRawColorInLayoutXml() {
        TestLintTask.lint()
            ...
            .expect(
                """
                    res/layout/incorrect_color_usages_layout.xml:12: Warning: Использование цветов не из палитры не допустимо [RawColorUsage]
                            android:background="#FF3700B3"
                                                ~~~~~~~~~
                    0 errors, 1 warnings
                """.trimIndent()
    ...
    fun detektRawColorInColorSelectorXml() {
        TestLintTask.lint()
            ...
            .expect(
                """
                    res/color/selector.xml:3: Warning: Использование цветов не из палитры не допустимо [RawColorUsage]
                        <item android:color="#5C6BC0" android:state_enabled="true" />
                                             ~~~~~~~
                    res/color/selector.xml:4: Warning: Использование цветов не из палитры не допустимо [RawColorUsage]
                        <item android:color="#C5CAE9" />
                                             ~~~~~~~
                    0 errors, 2 warnings
                """.trimIndent()
    ...
    fun detektRawColorInDrawableXml() {
        TestLintTask.lint()
            ...
            .expect(
                """
                    res/drawable/ic_baseline_adb_24.xml:4: Warning: Использование цветов не из палитры не допустимо [RawColorUsage]
                        android:tint="#b4ffff"
                                      ~~~~~~~
                    0 errors, 1 warnings
                """.trimIndent()

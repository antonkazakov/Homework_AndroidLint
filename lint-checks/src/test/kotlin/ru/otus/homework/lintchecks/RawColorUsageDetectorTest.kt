...
class RawColorUsageDetectorTest {
    ...
    fun `should detect raw colors usage case1`() {
        ...
        lintTask
            ...
            .expect(
                """
                    res/color/selector.xml:2: Warning: Используйте цвета описанные в colors.xml [RawColorUsage]
                        <item android:color="#5C6BC0" android:state_enabled="true" />
                              ~~~~~~~~~~~~~~~~~~~~~~~
                    res/color/selector.xml:3: Warning: Используйте цвета описанные в colors.xml [RawColorUsage]
                        <item android:color="#C5CAE9" />
                              ~~~~~~~~~~~~~~~~~~~~~~~
                    0 errors, 2 warnings
                """.trimIndent()
    ...
    fun `should detect raw colors usage case2`() {
        ...
        lintTask
            ...
            .expect(
                """
                    res/drawable/ic_baseline_adb_24.xml:4: Warning: Используйте цвета описанные в colors.xml [RawColorUsage]
                        android:tint="#b4ffff"
                        ~~~~~~~~~~~~~~~~~~~~~~
                    0 errors, 1 warnings
                """.trimIndent()
    ...
    fun `should detect raw colors usage case3`() {
        ...
        lintTask
            ...
            .expect(
                """
                    res/layout/incorrect_color_usages_layout.xml:11: Warning: Используйте цвета описанные в colors.xml [RawColorUsage]
                            android:background="#FF3700B3"
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                    res/layout/incorrect_color_usages_layout.xml:21: Warning: Используйте цвета описанные в colors.xml [RawColorUsage]
                            android:background="#00bcd4"
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                    res/layout/incorrect_color_usages_layout.xml:31: Warning: Используйте цвета описанные в colors.xml [RawColorUsage]
                            android:background="@android:color/holo_blue_dark"
                            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                    0 errors, 3 warnings
                """.trimIndent()

    ...
    fun `Testing colors`() {
        TestLintTask.lint()
            ...
            .checkFix(null,
                ...
                """
                    res/layout/incorrect_color_usages_layout.xml:13: Error: Usage of arbitrary colors isn`t allowed [ArbitraryColorsUsage]
                                android:background="#FF3700B3"
                                                    ~~~~~~~~~
                    res/layout/incorrect_color_usages_layout.xml:23: Error: Usage of arbitrary colors isn`t allowed [ArbitraryColorsUsage]
                                android:background="#00bcd4"
                                                    ~~~~~~~
                    2 errors, 0 warnings
                """.trimIndent()
